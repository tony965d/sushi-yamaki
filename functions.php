...
function my_setup() {
	...
	global $commitment;
  $commitment = esc_url(home_url( '/commitment' ));

	global $menu_page;
  $menu_page = esc_url(home_url( '/menu' ));
...
function my_script_init() { // my_script_init 関数の定義
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700&family=Roboto+Condensed:ital,wght@1,600&family=Shippori+Mincho:wght@400;600;700&family=Zen+Old+Mincho:wght@400;500;600;700&display=swap', array(), null );
