  ...
  <section class="mv-sub">
    <div class="mv-sub__wrapper">
      <picture class="mv-sub__image js-mv-sub">
        <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/mv_commitment.jpg" alt="">
      </picture>
    </div>
  </section>
    ...
    <div class="commitment-about__inner inner">
      ...
      <div class="commitment-about__images js-fadeUp">
        <div class="commitment-about__image">
          <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-about1.jpg" alt="">
        </div>
        <div class="commitment-about__image">
          <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-about2.jpg" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="commitment-pickup">
    <div class="commiment-pickup__inner inner">
      <div class="commiment-pickup__block unit-block unit-block--commitment">
        ...
        <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-pickup.jpg" alt="">
        </div>
      ...
      <div class="commitment-cuisine__wrapper">
        <div class="commitment-cuisine__block commitment-block commitment-block--egg">
          <div class="commitment-block__image js-fadeLeft">
            <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-block2.jpg" alt="">
          </div>
        ...
        <div class="commitment-cuisine__block commitment-block commitment-block--egg">
          <div class="commitment-block__image js-fadeLeft">
            <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-block3.jpg" alt="">
          </div>
          <div class="commitment-block__body js-fadeUp">
            <p class="commitment-block__text">
        ...
        <div class="commitment-cuisine__block commitment-block commitment-block--arajiru">
          <div class="commitment-block__image js-fadeLeft">
            <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-block4.jpg" alt="">
          </div>
          <div class="commitment-block__body js-fadeUp">
        ...
        <div class="commitment-soySauce__wrapper">
          ...
          <div class="commitment-soySauce__images js-fadeUp">
            <div class="commitment-soySauce__image">
              <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-soySauce1.jpg" alt="">
            </div>
            <div class="commitment-soySauce__image">
              <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-soySauce2.jpg" alt="">
            </div>
            <div class="commitment-soySauce__image">
              <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-soySauce3.jpg" alt="">
            </div>
          </div>
    ...
    <div class="commitment-soySauce__area">
      <div class="commitment-soySauce__area-inner inner">
        <div class="commitment-soySauce__area-image js-fadeUp">
          <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/commitment-soySauce__area.jpg" alt="">
        </div>
